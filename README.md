...
1. **Persiapan Folder:** Pastikan semua file tugas (`.ipynb`, file gambar, dan `requirements.txt`) berada dalam satu folder yang sama.
2. **Instalasi Dependensi:** Buka Terminal atau Git Bash pada direktori project, lalu jalankan perintah:
```bash
